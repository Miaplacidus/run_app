...
describe RunPal::JoinPost do
  ...
  it 'lets a user join a post/creates a commitment' do
    ...
    post = RunPal.db.create_post({latitude:30.25, longitude: -97.75, creator_id: user1.id, max_runners: 10, time: Time.now, pace: 3, notes: "Exercise!", min_amt: 3.15, age_pref: 3, gender_pref: 0, min_distance: 8})
